...
void LevelList::OnImGuiRender()
{
    ...
    if (!m_EditorLayer->m_CurrentLevelRegistry) {
        MC_ERROR("Level registry is null! Switching to main menu.");
...

    {
        ...
        {
            MC_PROFILE_SCOPE_NAME("LevelList::OnImGuiRender::LevelList");
        ...
        {
            MC_PROFILE_SCOPE_NAME("LevelList::OnImGuiRender::LoadLevel");
