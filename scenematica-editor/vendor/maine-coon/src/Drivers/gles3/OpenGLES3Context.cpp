...
void OpenGLES3Context::Init()
{
    ...
    // MC_CORE_ASSERT_TAGGED(egDisplay != EGL_NO_DISPLAY, "EGL has no display");
    // // if (egDisplay == EGL_NO_DISPLAY) {
    // //     // return EGL_FALSE;
    // // }
    //
    // // Initialize EGL
    // MC_CORE_ASSERT_TAGGED(eglInitialize(eglDisplay, &eglMajorVersion, &eglMinorVersion), "EGL failed to initialize");
    // // if (!eglInitialize(eglDisplay, &eglMajorVersion, &eglMinorVersion)) {
    // //     // return EGL_FALSE;
    // // }
    //
    // // Get configs
    // MC_CORE_ASSERT_TAGGED(eglGetConfigs(eglDisplay, NULL, 0, &eglNumConfigs), "EGL failed to get configs");
    // // if (!eglGetConfigs(eglDisplay, NULL, 0, &eglNumConfigs)) {
    // //     // return EGL_FALSE;
    // // }
    //
    // MC_CORE_ASSERT_TAGGED(eglChooseConfig(eglDisplay, eglConfigAttribList, &eglConfig, 1, &eglNumConfigs), "EGL failed to choose configs");
    ...
    // // MC_CORE_ASSERT_TAGGED(eglSurface != EGL_NO_SURFACE, "EGL has no surface");
    // // // if (eglSurface == EGL_NO_SURFACE) {
    // // //     // return EGL_FALSE;
    // // // }
    //
    // eglContext = eglCreateContext(eglDisplay, eglConfig, EGL_NO_CONTEXT, eglContextAttribs);
    // MC_CORE_ASSERT_TAGGED(eglSurface != EGL_NO_SURFACE, "EGL has no context");
    // // if (context == EGL_NO_CONTEXT) {
    // //     // return EGL_FALSE;
    // // }
    //
    // MC_CORE_ASSERT_TAGGED(eglMakeCurrent(eglDisplay, eglSurface, eglSurface, eglContext), "EGL failed to make current");
    ...
    MC_CORE_ASSERT_TAGGED(major > 3 || (major == 3 && minor >= 0), "MaineCoon requires at least OpenGL ES version 3.0!");
}
